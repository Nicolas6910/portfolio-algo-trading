...
DEFAULT_DISPLAY_PARAMS = {
    'triangles': {
        ...
        'y_multiplier': {
            'red': 1.001,   # Positionnement des triangles rouges
            'green': 0.999  # Positionnement des triangles verts
        }
    }
}

# Symbole pour PEPE/USDT en futures perpétuels
symbol = 'PEPE/USDT:USDT'

# Timeframes disponibles
AVAILABLE_TIMEFRAMES = ['1m', '5m', '15m', '30m', '1h', '4h', '1d']

# Mapping des timeframes à leur équivalent en minutes
TIMEFRAME_MAPPING = {
    '1m': 1,
    '5m': 5,
    '15m': 15,
...
app.layout = html.Div([
    ...
    dcc.Interval(
        ...
        interval=15 * 60 * 1000,  # Mise à jour toutes les 15 minutes (900000 ms)
        n_intervals=0
    )
], style={'padding': '10px'})
